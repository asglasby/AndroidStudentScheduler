...
public class CourseListDetailAdapter extends BaseAdapter {
    ...
    public CourseListDetailAdapter(Context context, ArrayList<Course> courseArrayList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.custom_course_detail_listview,null);
