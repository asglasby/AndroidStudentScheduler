...
public class AssessmentDetailAdapter extends BaseAdapter {
    Context context;
    ArrayList<Assessment> assessmentArrayList;

    public AssessmentDetailAdapter(Context context, ArrayList<Assessment> assessmentArrayList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.assessment_detail_listview,null);
