...
public class TermDetailAdapter extends BaseAdapter {
    Context context;
    ArrayList<Term> termArrayList;
    public TermDetailAdapter(Context context, ArrayList<Term> termArrayList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.custom_term_detail_listview,null);
