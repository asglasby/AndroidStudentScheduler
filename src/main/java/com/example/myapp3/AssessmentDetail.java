...
public class AssessmentDetail extends OptionsMenuActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDbConnection = new DbHelper(AssessmentDetail.this);
        ...
        assessmentListListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(AssessmentDetail.this, EditorAssessmentActivity.class);
    ...
    public void loadAssessmentData(){
        ...
        assessmentAdapter = new AssessmentDetailAdapter(this, allAssessmentsArrayList);
