...
import com.example.myapp3.Adapters.CourseListDetailAdapter;
import com.example.myapp3.Models.Course;

import java.util.ArrayList;

public class CourseDetail extends OptionsMenuActivity {
    ...
    CourseListDetailAdapter courseAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDbConnection = new DbHelper(CourseDetail.this);
        ...
        courseListListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(CourseDetail.this, EditorCourseActivity.class);
    ...
    public void loadCourseData(){
        ...
        courseAdapter = new CourseListDetailAdapter(this, allCoursesArrayList);
